/* ============================================================
   ...
   ⚠ This is a VERBATIM copy of app/js/ats/ats-engine.js. A Chrome extension
   can only load files inside its own folder, so the engine is duplicated here
   for the auto-apply content script to reuse. Keep the two files in sync — if
   you change one, change the other (they are byte-identical below this note).
