...
const QueueAutoApply = (() => {
  ...
  /* called by the Queue when it opens a job in a new tab */
  ...
  function bind() {
    ...
    _bound = true;
    document.addEventListener('careerpilot:needs-attention', function (ev) {
      const d = (ev && ev.detail) || {};
      if (typeof ApplicationQueue === 'undefined' || !ApplicationQueue.markAttentionFor) return;
