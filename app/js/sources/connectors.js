...
const Connectors = (() => {
  ...
  function fromLinkedIn(r) {
    return {
      ...
      visaSponsorship: !!r.sponsor, companyLogo: null, languagesRequired: r.langs || [],
  ...
  function fromBayt(r) {
    return {
      ...
      visaSponsorship: !!r.visa, companyLogo: null, languagesRequired: r.languages || [],
  ...
  function fromGulfTalent(r) {
    return {
      ...
      visaSponsorship: !!r.sponsorship, companyLogo: null, languagesRequired: r.langNeeds || [],
  ...
  function fromCareersPortal(r) {
    return {
      ...
      visaSponsorship: !!r.visaHelp, companyLogo: null, languagesRequired: r.languages || [],
